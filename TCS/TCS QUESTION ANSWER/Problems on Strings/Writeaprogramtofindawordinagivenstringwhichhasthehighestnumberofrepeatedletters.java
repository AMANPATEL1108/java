public class Writeaprogramtofindawordinagivenstringwhichhasthehighestnumberofrepeatedletters {
    static void HighestRepeatedLetters(String str) {
        ...
        if (result.equals("")) {
            ...
            System.out.println("WOrd with highest number of repeated letters: ");
    ...
    public static void main(String[] args) {
        String str = "abcdef g google microsoft";
